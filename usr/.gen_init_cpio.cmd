cmd_usr/gen_init_cpio :=  gcc -Wp,-MD,usr/.gen_init_cpio.d -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -fomit-frame-pointer -std=gnu89      -o usr/gen_init_cpio usr/gen_init_cpio.c  
